            ...
            VStack{
                ...
                List{
                    ...
                    Section{
                        ...
                        Text("There are 10 rounds in total throughout the game. If you look right below the word👇🏼, you will see two buttons, one with Ukrainian flag 🇺🇦 and one with English flag 🏴󠁧󠁢󠁥󠁮󠁧󠁿. One button will pronounce the word in 🇺🇦 Ukrainian and the other one will translate it and pronounce it in 🏴󠁧󠁢󠁥󠁮󠁧󠁿 English. English button is more of a hint button 🫣 that you can use when you don't know what the word really means🤔. The Ukrainian button can be used all throughout the game to learn the pronounciation 🗣️ and is a part of learning experience. Make sure that your device 📲 is not on mute 🔇 when you tap on these buttons, otherwise, you will not hear it 👂🏼. There is also a small display of the current round of the game at the bottom of the game screen 📲👇🏼.")
                    }
                    .listRowBackground((Color.black.opacity(0.8)))
                    .foregroundColor(.white)
                    .listRowSeparatorTint(.white)
